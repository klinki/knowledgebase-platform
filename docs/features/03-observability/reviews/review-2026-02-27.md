...
## References
- [Program.cs](/docs/backend/src/SentinelKnowledgebase.Api/Program.cs)
- [MonitoringService.cs](/docs/backend/src/SentinelKnowledgebase.Application/Services/MonitoringService.cs)
- [appsettings.json](/docs/backend/src/SentinelKnowledgebase.Api/appsettings.json)
- [HangfireStorageHealthCheck.cs](/docs/backend/src/SentinelKnowledgebase.Api/HealthChecks/HangfireStorageHealthCheck.cs)

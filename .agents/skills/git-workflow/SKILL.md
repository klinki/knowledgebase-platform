...
description: Operational protocol for Git version control and Conventional Commits.
triggers:
  - "commit changes"
  - "create commit"
  - "git commit"
...
3. **Insert Signature**: Append the dynamic `Co-authored-by` footer for the active editor + model.
